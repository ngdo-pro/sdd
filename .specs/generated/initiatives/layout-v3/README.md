...
* **Migration idempotente:** `spec migrate` convertit un workspace v2 (`.specs/`) vers v3 (`.sdd/`) sans perte, ré-exécutable sans effet de bord, et le graphe (ids, relations, progress) est préservé.
