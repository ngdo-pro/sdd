...
- [x] **Phase 3: Cutover one-shot, repointage, E2E & quality gates**
  - [x] Cutover du workspace courant (commit propre, `--dry-run` d'abord) : `spec render` → vérifier `git status` (`generated/**` ajoutés, arbre v2 supprimé, `canonical/index.json` reciblé) ; supprimer les répertoires vides résiduels si besoin.
