# Feature: Câblage par copie (zéro path local)
...
- [x] **`012-installed-copies`** : Câblage par copie (zéro path local)  
  ↳ *Spec:* [`generated/initiatives/adoption/specs/012.md`](../specs/012.md)
