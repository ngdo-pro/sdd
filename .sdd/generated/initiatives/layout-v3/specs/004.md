...
sequenceDiagram
    ...
    Note over U,S: À tout instant : spec validate tolère site/ (règle root-layout, racine exhaustive) ; spec render --check ignore site/ (couverture generated/ seule) ; le .gitignore racine n'est posé que par spec init
```
