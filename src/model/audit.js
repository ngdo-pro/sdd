 ...
 * `generated/`, `knowledge/` and `site/` may live there. Dotfiles (`.DS_Store`,
 * `.gitkeep`, `.migration-failed.json`) are tolerated; `generated/`, `site/`
 * and `knowledge/` are permitted without being required.
 */
