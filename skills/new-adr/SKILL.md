...
1. Determine the next sequential ID (`ADR-XXX`) in `.sdd/knowledge/decisions/architecture/`.
...
4. Create the document in `.sdd/knowledge/decisions/architecture/ADR-XXX-[slug].md`.
