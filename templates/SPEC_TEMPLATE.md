> **Model-first note (rule 7):** this template describes the **body** of a specification.
> Only sections 1-8 and the Appendix are authored. The `# Spec: XXX - Title` line and the
> `## Metadata` block are generated by `spec upsert` from the canonical model
> (`.sdd/canonical/initiatives/<initiative>/features/<feature>/specs/<id>.json`) — never write them into the body file, and
> never edit the generated `.sdd/generated/initiatives/[initiative]/specs/[id].md` projection.


# Spec: [XXX] - [Specification Title]

## Metadata
* **Domain:** `.sdd/knowledge/domains/[domain-name]/`
