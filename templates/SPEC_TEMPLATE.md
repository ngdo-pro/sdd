...
> (`.specs/model/specs/<state>/XXX-slug.json`) — never write them into the body file, and
> never edit the generated `.specs/generated/initiatives/[initiative]/specs/[id].md` projection.
