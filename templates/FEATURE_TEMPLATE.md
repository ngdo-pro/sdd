> **Model-first note (rule 7):** this template describes the **body** of a feature.
> Only sections 1-5 are authored; `## 6. Implementation Spec(s)` is **generated** from the
> specs linked to this feature. The `# Feature: …` title and the blockquote header
> (`> **Parent Initiative:**`, `> **Status:**`) are generated by `spec upsert` from the model.
...
- [ ] **`[XXX-[slug]]`** : [Spec Title]  
  ↳ *Spec:* [`.sdd/generated/initiatives/[initiative]/specs/[id].md`](../../../../generated/initiatives/[initiative]/specs/[id].md) *(projection — regenerated by the CLI)*
